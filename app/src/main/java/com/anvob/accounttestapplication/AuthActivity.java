package com.anvob.accounttestapplication;
...
import com.anvob.accounttestapplication.AccountAuthenticator.AccountGeneral;

import java.io.IOException;

import static com.anvob.accounttestapplication.AccountAuthenticator.AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS;
...
public class AuthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnGetVkToken).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAccountPickerVk(AUTHTOKEN_TYPE_FULL_ACCESS, false);
            }
        });
     ...
     * @param authTokenType
     */
    private void showAccountPickerVk(final String authTokenType, final boolean invalidate) {
        mInvalidate = invalidate;
        final Account availableAccounts[] = mAccountManager.getAccountsByType("com.google");
//AccountManager.com.twitter.android.auth.login"
        if (availableAccounts.length == 0) {
            Toast.makeText(this, "No accounts", Toast.LENGTH_SHORT).show();
        } else {
            String name[] = new String[availableAccounts.length];
    ...
    private void getExistingAccountAuthToken(final Account account, String authTokenType) {
        final AccountManagerFuture<Bundle> future = mAccountManager.getAuthToken(account, "oauth2:https://www.googleapis.com/auth/userinfo.profile", null, this, null, null);
